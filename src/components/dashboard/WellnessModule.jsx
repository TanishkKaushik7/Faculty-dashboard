...
import { Heart, Brain, Dumbbell, Calendar, TrendingUp, Target, Award, Smile } from "lucide-react";
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4">
                {["😊", "😐", "😔", "😰", "😴"].map((emoji, index) => (
                  <Button key={index} variant="outline" className="h-16 text-2xl">
                    {emoji}
                  </Button>
                ))}
              </div>
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea className="w-full p-2 border rounded-md h-20" placeholder="What made your day better?"></textarea>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <Button className="mt-3 w-full" variant="outline">Log Exercise</Button>
              </CardContent>
            </Card>
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <Button className="mt-3 w-full" variant="outline">Log Mental Activity</Button>
              </CardContent>
            </Card>
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <Button className="mt-3 w-full" variant="outline">Log Social Activity</Button>
              </CardContent>
            </Card>
          </div>
                ...
                {activities.map((activity) => (
                  <div key={activity.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-4">
                      <div className="text-3xl">{getMoodEmoji(activity.mood)}</div>
                      <div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="number" className="w-full p-2 border rounded-md" placeholder="e.g., 8000" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-blue-600">Happy 😊</span>
                    </div>
                    <div className="flex justify-between items-center">
